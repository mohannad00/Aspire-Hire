...
class SignUpPhoneEmployee extends StatefulWidget {
  const SignUpPhoneEmployee({super.key});

  @override
  _SignUpPhoneEmployeeState createState() => _SignUpPhoneEmployeeState();
}

class _SignUpPhoneEmployeeState extends State<SignUpPhoneEmployee> {
  bool isSignUp = true;
  @override
        ...
        leading: ReusableBackButton.build(
          ...
          onPressed: () {
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(
                  builder: (context) => const SignUpEmailEmployee()),
            );
          },
        ),
      ),
                ...
                child: ReusableButton.build(
                  ...
                  onPressed: () {
                    Navigator.pushReplacement(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const SignUpUserNameEmployee()),
                    );
                  },
                ),
              ),
