...
class SignUpEmailEmployee extends StatefulWidget {
  const SignUpEmailEmployee({super.key});

  @override
  _SignUpEmailEmployeeState createState() => _SignUpEmailEmployeeState();
}

class _SignUpEmailEmployeeState extends State<SignUpEmailEmployee> {
  bool isSignUp = true;
