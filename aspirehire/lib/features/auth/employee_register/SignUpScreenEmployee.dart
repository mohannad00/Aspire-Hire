...
class SignUpScreenEmployee extends StatefulWidget {
  const SignUpScreenEmployee({super.key});

  @override
  _SignUpScreenEmployeeState createState() => _SignUpScreenEmployeeState();
}

class _SignUpScreenEmployeeState extends State<SignUpScreenEmployee> {
  bool isSignUp = true;
  @override
