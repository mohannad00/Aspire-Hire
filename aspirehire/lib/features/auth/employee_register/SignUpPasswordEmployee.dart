...
class SignUpPasswordEmployee extends StatefulWidget {
  const SignUpPasswordEmployee({super.key});

  @override
  _SignUpPasswordEmployeeState createState() => _SignUpPasswordEmployeeState();
}

class _SignUpPasswordEmployeeState extends State<SignUpPasswordEmployee> {
  bool isSignUp = true;
