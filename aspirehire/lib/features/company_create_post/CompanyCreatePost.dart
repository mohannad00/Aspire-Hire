...
import 'state_management/company_create_post_cubit.dart';
import 'state_management/company_create_post_state.dart';
...
class _CompanyCreatePostState extends State<CompanyCreatePost> {
  ...
  late CompanyCreatePostCubit _createPostCubit;

  @override
  void initState() {
    super.initState();
    _loadToken();
    _createPostCubit = CompanyCreatePostCubit();
  }
  ...
  Future<void> _pickImage() async {
    try {
      ...
      if (media != null && mounted) {
        ...
        // ignore: avoid_print
        print('🟢 [CompanyCreatePost] Original file path: $filePath');
        // ignore: avoid_print
        print('🟢 [CompanyCreatePost] Detected extension: $extension');
        ...
        // ignore: avoid_print
        print(
          '🟢 [CompanyCreatePost] File size: ${fileSizeInMB.toStringAsFixed(2)} MB',
        );
        ...
        // ignore: avoid_print
        print(
          '🟢 [CompanyCreatePost] Final selected image path: ${_selectedImage!.path}',
        );
      }
    } catch (e) {
      if (mounted) {
  ...
  void _createPost() {
    ...
    if (_selectedImage != null) {
      ...
      final String extension = filePath.split('.').last.toLowerCase();
      // ignore: avoid_print
      print('🟢 [CompanyCreatePost] Image extension before API: $extension');
    }
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: Builder(
        builder: (context) {
          return BlocConsumer<CompanyCreatePostCubit, CompanyCreatePostState>(
            listener: (context, state) {
              print(
                '🟢 [CompanyCreatePost] State changed: ${state.runtimeType}',
              );
              if (state is CompanyCreatePostSuccess) {
                print(
                  '🟢 [CompanyCreatePost] Success! Navigating to company home...',
                );
              ...
              } else if (state is CompanyCreatePostFailure) {
                print('🔴 [CompanyCreatePost] Failure: ${state.error}');
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
            ...
            builder: (context, state) {
              _isLoading = state is CompanyCreatePostLoading;
              ...
              return Scaffold(
                ...
                appBar: AppBar(
                  ...
                  title: const Text("Create Company Post"),
                  actions: [
                    TextButton(
